...
export class MathService {
  ...
  public giniToSigma(gini: number): number {
  ...
  public lognormal(x: number, sigma:number, mu:number): number {
    return Math.exp(
